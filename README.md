...
When water bridges the detection probes, it provides gate voltage to a 2N7000 N-channel MOSFET, switching it on and simultaneously activating a piezo buzzer and LED indicator. A 1N4007 flyback diode protects the MOSFET from inductive voltage spikes generated when the buzzer deactivates. A 10kΩ gate pull-down resistor prevents false triggering from floating gate voltage. A 1nF gate capacitor provides noise filtering.
...
Components Used:
- 2N7000 N-channel MOSFET — switching element
- 1N4007 — flyback protection diode
- Buzzer — audible alarm output
- LED — visual alarm indicator
- 10KΩ resistor — gate pull-down
- 1nF capacitor — gate noise filter
- Detection probes — water sensing

Key Skills Learned:
- MOSFET switching circuit design
